...
enum BUILDINGS {
	NADA, FARM_ONE, FARM_TWO, FARM_THREE, WHEAT, HOUSE, BRIDGE, DOCK, WORKSHOP, WINDMILL, FORT, OFFICE
};
...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building(3, 11, true)); //Pier 3 
	buildings.push_back(UI_Building(3, 11, true)); //Canal 3 
	buildings.push_back(UI_Building(6, 9, false, true, 6, 8)); //Workshop 4
	buildings.push_back(UI_Building(8, 6, false, false, 6, 6)); //Windmill 5
	buildings.push_back(UI_Building(8, 7, false, true)); //Fort 6
	buildings.push_back(UI_Building(8, 10, false, true)); //Office  7
