...
std::vector<Policy> initPolicies() {
	...
	policies.push_back(Policy(3, "Efficient Housing", "Houses provide*GREEN* +3 *GREEN* population space."));
	...
	policies.push_back(Policy(2, "Hillforts", "Units have *GREEN*+1*GREEN* defense when fighting from higher elevation."));
