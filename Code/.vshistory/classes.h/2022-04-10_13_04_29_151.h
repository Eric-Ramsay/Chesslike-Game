...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building(1, 1, 5)); //Stakes 1
	buildings.push_back(UI_Building(3, 5, 10, true)); //House 1
	buildings.push_back(UI_Building(3, 12, 10)); //Bridge 2
	buildings.push_back(UI_Building(3, 8, 10)); //Canal 3
	buildings.push_back(UI_Building(3, 11, 8, true)); //Pier 4
	buildings.push_back(UI_Building(3, 11, 8)); //Trade Depot
	buildings.push_back(UI_Building(6, 9, 15, false, true, 6, 8)); //Workshop 5
	buildings.push_back(UI_Building(8, 6, 15, false, false, 6, 6)); //Windmill 6
	buildings.push_back(UI_Building(8, 7, 30, false, true)); //Fort 7
	buildings.push_back(UI_Building(8, 10, 15, false, true)); //Office 8
...
enum UNITS {
	...
	COMMANDER, MAYOR, FISHING_RAFT, WARSHIP, TRIREME, MAGE
};
