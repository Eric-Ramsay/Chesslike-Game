...
std::vector<Perk> initPerks() {
	...
	perks.push_back(Perk("Efficient Housing", "Houses provide * GREEN * +3 * GREEN * population space."));
	perks.push_back(Perk("Sustainable Fishing", "*ORANGE*Fish*ORANGE* replenish every turn."));
	perks.push_back(Perk("Forced Levy", "No *GOLD*upkeep*GOLD* for workers*PURPLE* and *PURPLE*spearmen*PURPLE*."));
