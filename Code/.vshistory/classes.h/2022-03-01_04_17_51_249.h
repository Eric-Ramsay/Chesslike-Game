...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building(4, 6)); //Bridge
	buildings.push_back(UI_Building(4, 7)); //Dock
	buildings.push_back(UI_Building(6, 8, false, true, 6, 8)); //Workshop
	buildings.push_back(UI_Building(8, 9, false, false, 6, 6)); //Windmill
	buildings.push_back(UI_Building(8, 10, false, true)); //Fort
