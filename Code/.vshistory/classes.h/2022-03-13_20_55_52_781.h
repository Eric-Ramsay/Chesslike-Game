...
std::vector<Perk> initPerks() {
	...
	perks.push_back(Perk("Efficient Housing", "*BROWN*Houses*BROWN* provide *GREEN*+3*GREEN* *GOLD*population space*GOLD*."));
	...
	perks.push_back(Perk("Woodsmen", "No movement penalty from *GREEN*forests*GREEN*."));
	perks.push_back(Perk("Mountaineers", "No movement penalty from *GREEN*hills*GREEN*."));
