...
std::vector<UI_Unit> initUnits() {
	...
	//---------------------MP, HP,AT,DF,RG,COST
	units.push_back(UI_Unit(2, 4, 1, 1, 1, 1)); //Peasant Levy
	units.push_back(UI_Unit(2, 6, 3, 4, 1, 2)); //Spearmen
	units.push_back(UI_Unit(3, 4, 4, 4, 3, 4)); //Archers
	units.push_back(UI_Unit(2, 15, 8, 8, 1, 5)); //Knights
	units.push_back(UI_Unit(5, 6, 4, 3, 3, 5)); //Cav Archer
	units.push_back(UI_Unit(6, 12, 5, 5, 1, 5)); //Light Cavalry
