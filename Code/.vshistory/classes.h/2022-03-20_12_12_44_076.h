...
enum POLICY_NAME {
	HOUSING, FISHING, LEVY, SPEARS, WOODSMEN, MOUNTAINEERS, LOGGING, HUSBANDRY, HILLFORTS, MEDICINE, BARRACKS, VOLUNTEERS
};
std::vector<Policy> initPolicies() {
	...
	policies.push_back(Policy(2, "Accomodations", "Units on forts and ships on piers have *GREEN*no Upkeep*GREEN*"));	//
	policies.push_back(Policy(2, "Volunteers", "You may *GREEN*recruit*GREEN* units on forts and ships on piers"));		//
