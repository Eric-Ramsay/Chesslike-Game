...
std::vector<Perk> initPerks() {
	...
	perks.push_back(Perk("Woodsmen", "No *BLUE*movement penalty*BLUE* from *GREEN*forests*GREEN*."));
	perks.push_back(Perk("Mountaineers", "No *BLUE*movement penalty*BLUE* from *GREEN*hills*GREEN*."));
