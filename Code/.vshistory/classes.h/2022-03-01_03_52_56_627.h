...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building(3, 5)); //House
	buildings.push_back(UI_Building(4, 6)); //Bridge
	buildings.push_back(UI_Building(4, 7)); //Dock
	buildings.push_back(UI_Building(6, 8)); //Workshop
	buildings.push_back(UI_Building(8, 9)); //Windmill
	buildings.push_back(UI_Building(8, 10)); //Fort
