...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building(3, 8, 10, true)); //House 1
	buildings.push_back(UI_Building(3, 9, 12)); //Bridge 2
	buildings.push_back(UI_Building(3, 9, 8)); //Canal 3
	buildings.push_back(UI_Building(3, 6, 11, true)); //Pier 4
	buildings.push_back(UI_Building(6, 15, 9, false, true, 6, 8)); //Workshop 5
	buildings.push_back(UI_Building(8, 15, 6, false, false, 6, 6)); //Windmill 6
	buildings.push_back(UI_Building(8, 30, 7, false, true)); //Fort 7
	buildings.push_back(UI_Building(8, 15, 10, false, true)); //Office 8
