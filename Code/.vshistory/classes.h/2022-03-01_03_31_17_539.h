...
struct UI_Building {
	...
	UI_Building(short c, short t, short x, short y, bool tc = false, bool bc = false, short an = 1, short as = 1) {
		cost = c;
		type = t;
		anim_num = an;
		anim_speed = as;
...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building(1, 5)); //House
	buildings.push_back(UI_Building(1, 6)); //Bridge
	buildings.push_back(UI_Building(1, 7)); //Dock
	buildings.push_back(UI_Building(1, 8)); //Workshop
	buildings.push_back(UI_Building(1, 9)); //Windmill
	buildings.push_back(UI_Building(1, 10)); //Fort
