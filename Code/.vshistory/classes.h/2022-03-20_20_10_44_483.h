...
enum POLICY_NAME {
	HOUSING, FISHING, LEVY, SPEARS, HARDY, RANGERS, LOGGING, HUSBANDRY, HILLFORTS, MEDICINE, BARRACKS, VOLUNTEERS
};
std::vector<Policy> initPolicies() {
	...
	policies.push_back(Policy(3, "Sustainable Fishing", "*ORANGE*Fish*ORANGE* replenish every turn."));					//coded
	...
	policies.push_back(Policy(2, "Rangers", "No *GREEN*movement*GREEN* penalties from forests or elevation."));			//
	policies.push_back(Policy(2, "Hardy Folk", "Peasants and fishing ships have 8 Max HP"));							//
	...
	policies.push_back(Policy(2, "Hillforts", "Units with an elevation advantage have *GREEN*+1*GREEN* defense."));		//coded
	policies.push_back(Policy(2, "Field Medicine", "*GREEN*Heal*GREEN* one unit for 4 HP each turn."));					//
