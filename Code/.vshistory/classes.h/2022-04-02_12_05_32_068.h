...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building(1, 1, 2)); //Farm 0
	buildings.push_back(UI_Building(3, 5, 2, true)); //House 1
	buildings.push_back(UI_Building(3, 12, 2)); //Bridge 2
	buildings.push_back(UI_Building(3, 8, 2)); //Canal 3
	buildings.push_back(UI_Building(3, 11, 2, true)); //Pier 4
	buildings.push_back(UI_Building(6, 9, 2, false, true, 6, 8)); //Workshop 5
	buildings.push_back(UI_Building(8, 6, 2, false, false, 6, 6)); //Windmill 6
	buildings.push_back(UI_Building(8, 7, 2, false, true)); //Fort 7
	buildings.push_back(UI_Building(8, 10, 2, false, true)); //Office 8
