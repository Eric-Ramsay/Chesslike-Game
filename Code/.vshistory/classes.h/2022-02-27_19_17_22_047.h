...
struct UI_Unit {
	...
	UI_Unit(short m, short h, short a, short d, short r, short c, bool cr = true, bool n = false) {
		sY = 0;
...
std::vector<UI_Unit> initUnits() { //Initialize unit types
	...
	units.push_back(UI_Unit(4, 20, 8, 4, 1, 8, false)); //8) Commander
	units.push_back(UI_Unit(2, 12, 2, 2, 2, 8, false)); //9) Mayor
	units.push_back(UI_Unit(3, 6, 2, 2, 2, 2, true, true)); //10) fishing raft
	units.push_back(UI_Unit(4, 20, 3, 3, 3, 6, true, true)); //11) warship
