...
std::vector<Policy> initPolicies() {
	...
	policies.push_back(Policy(3, "Forced Levy", "Slain peasants don't give *FIRE*enemies*FIRE* *GOLD*gold*GOLD*. Workers/Spears *GREEN*no upkeep*GREEN*."));
	...
	policies.push_back(Policy(1, "Hardy Folk", "Peasants and fishing ships have 8 Max HP and 2 ATK"));
	...
	policies.push_back(Policy(1, "Hillforts", "Units with an elevation advantage have *GREEN*+1*GREEN* defense."));
