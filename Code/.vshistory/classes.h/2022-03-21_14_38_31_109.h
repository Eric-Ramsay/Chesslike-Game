...
std::vector<Policy> initPolicies() {
	...
	policies.push_back(Policy(3, "Levies", "Slain peasants don't give enemies *GOLD*gold*GOLD*. Workers/Spears *GREEN*no upkeep*GREEN*."));
	...
	policies.push_back(Policy(2, "Field Medicine", "*GREEN*Heal*GREEN* one unit for *GREEN*4*GREEN* HP each turn."));
