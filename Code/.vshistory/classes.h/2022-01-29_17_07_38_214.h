...
std::vector<UI_Unit> initUnits() { //Initialize unit types
	...
	//---------------------MP, HP,AT,DF,RG,COST
	units.push_back(UI_Unit(2, 4, 1, 1, 2, 1)); //Peasant Levy
	units.push_back(UI_Unit(2, 8, 3, 4, 1, 3)); //Spearmen
	units.push_back(UI_Unit(3, 4, 4, 4, 3, 4)); //Archers
	units.push_back(UI_Unit(2, 15, 8, 8, 1, 5)); //Heavy Infantry
	units.push_back(UI_Unit(5, 6, 4, 3, 3, 5)); //Cav Archer
	units.push_back(UI_Unit(6, 12, 5, 4, 1, 5)); //Light Cavalry
	units.push_back(UI_Unit(4, 20, 9, 5, 1, 8)); //Heavy Cavalry
	units.push_back(UI_Unit(4, 20, 9, 5, 1, 10)); //Commander
	units.push_back(UI_Unit(2, 20, 7, 9, 1, 10)); //Mayor
