...
std::vector<Perk> initPerks() {
	...
	perks.push_back(Perk("Efficient Housing", "Houses provide +3 population space."));
	perks.push_back(Perk("Sustainable Fishing", "Fish replenish every turn."));
	perks.push_back(Perk("Forced Levy", "No upkeep for peasants, spearmen, and fishing ships."));
	perks.push_back(Perk("Sharper Spears", "Spearmen +1 Attack."));
	...
	perks.push_back(Perk("Equine Husbandry", "Cavalry units +1 Movement."));
