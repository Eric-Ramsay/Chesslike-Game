...
enum POLICY_NAME {
	HOUSING, FISHING, LEVY, PIKES, RANGERS, HARDY, LOGGING, HUSBANDRY, HILLFORTS, MEDICINE, BARRACKS, VOLUNTEERS, DONKEYS, FORTIFICATIONS
};
...
struct UI_Unit {
	...
	UI_Unit(std::string n, short m, short h, short a, short d, short r, short c, bool n = false, bool cb = true) {
		sY = 0;
