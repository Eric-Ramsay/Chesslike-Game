...
public:
	...
	void DrawBuilding(int type, int dX, int dY, float scale, C c = C(15, 15), olc::Pixel owner = olc::WHITE, olc::Pixel pix = olc::WHITE) {
		...
		if (index == 0) { //Farm
			...
			DrawPartialDecal(olc::vf2d(d.x, d.y), building_sprites, olc::vf2d(sX, sY), olc::vf2d(16, 32), olc::vf2d(z, z), pix);
		}
		if (buildings[index].top_color) {
			DrawPartialDecal(olc::vf2d(d.x, d.y), building_sprites, olc::vf2d(sX, sY - 16), olc::vf2d(16, 16), olc::vf2d(z, z), owner);
		}
