...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override {
		...
		if (!drawMap) {
			...
			Print("Loading Map. Please be patient. . .", ScreenWidth()/2, ScreenHeight()/2, true, 2.0);
			
			DrawPartialDecal(olc::vf2d(ScreenWidth()/2 - 80, dY - zom), buildings, olc::vf2d(32, 32 * ((timer / 5) % 6)), olc::vf2d(16, 32), olc::vf2d(z, z));
			DrawPartialDecal(olc::vf2d(, dY - zom), buildings, olc::vf2d(32, 32 * ((timer / 5) % 6)), olc::vf2d(16, 32), olc::vf2d(z, z));
			DrawPartialDecal(olc::vf2d(dX, dY - zom), buildings, olc::vf2d(32, 32 * ((timer / 5) % 6)), olc::vf2d(16, 32), olc::vf2d(z, z));
		}
