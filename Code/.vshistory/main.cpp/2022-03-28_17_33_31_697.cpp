...
public:
	...
	void DrawUI() {
		...
		if (MM_active) {
			...
			//Population
			Draw(icons, 4 + 43*scale, 2, 0, 16, 43, 15, scale);
			Draw(icons, 4 + 45*scale, 2+2*scale, 96, 16, 11, 11, scale);
			Draw(icons, 4 + 45*scale, 2+2*scale, 96, 16, 11, 11, scale, colors[p.turn]);
			Draw(icons, 4 + 43*scale, 2, 0, 32, 15, 15, scale, colors[p.turn]);
			...
			Draw(icons, 6 + 86 * scale, 2, 0, 16, 43, 15, scale);
			Draw(icons, 6 + 88 * scale, 2, 0, 32, 15, 15, scale, colors[p.turn]);
			Print(to_str(p.units.size()), 2 + 64 * scale, 2 + 8 * scale, true, scale); //Pop
			Print(to_str(p.max_pop), 4 + 78 * scale, 2 + 8 * scale, true, scale); //Max Pop

			Draw(icons, 6 + 86 * scale, 2, 0, 0, 43, 15, scale);
			Draw(icons, 6 + 88 * scale, 2 + 2 * scale, 80, 16, 11, 11, scale);
			Print(to_str(p.upkeep), 6 + 113 * scale, 2 + 8 * scale, true, scale);

			//Unit Upkeep
			Draw(icons, 6 + 86*scale, 2, 0, 0, 43, 15, scale);
			Draw(icons, 6 + 88 * scale, 2 + 2 * scale, 112, 32, 11, 11, scale);
			Print(to_str(p.upkeep), 6 + 113 * scale, 2 + 8 * scale, true, scale);
