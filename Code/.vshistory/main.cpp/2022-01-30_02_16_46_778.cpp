...
private:
	...
	void initAudio() {
		...
		music_list[1].load("./Sounds/song1.wav");
		music_list[2].load("./Sounds/song1.wav");
		music_list[3].load("./Sounds/song1.wav");

		wav_t1.load("./Sounds/song1.wav");
		wav_t2.load("./Sounds/song2.wav");
		wav_t3.load("./Sounds/song3.wav");
		wav_t4.load("./Sounds/song4.wav");
		wav_birds.load("./Sounds/bird.wav");

		music_list.push_back(wav_t1);
		music_list.push_back(wav_t2);
		music_list.push_back(wav_t3);
		music_list.push_back(wav_t4);
	}
	void handleAudio() {
		if (!audio_init) {
			initAudio();
	...
	//Game Loop Variables
	float fTargetFrameTime = 1.0f / 30.0; // Virtual FPS of 30fps
