...
public:
	...
	void DrawDrag() { //Draw unit that is being dragged
		...
		if (dragging_unit) {
			...
			DrawPartialDecal(olc::vf2d(dX, dY - zoom), armySprites, olc::vf2d(sX, sY + 32), olc::vf2d(16, 16), olc::vf2d(z, z), ap); //Draw Color
			...
			DrawPartialDecal(olc::vf2d(dX, dY - zoom), armySprites, olc::vf2d(units[unit_selected].sX, units[unit_selected].sY + 32), olc::vf2d(16, 16), olc::vf2d(z, z), ap);
		}
