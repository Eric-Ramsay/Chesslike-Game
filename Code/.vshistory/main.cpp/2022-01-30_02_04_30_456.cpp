...
private:
	...
	//AUDIO FILES
	SoLoud::Wav wav_track_one;
	SoLoud::Wav wav_track_two;
	SoLoud::Wav wav_track_three;
	SoLoud::Wav wav_track_four;
	...
	void initAudio() {
		audio.init();
		wav_track_one.load("./Sounds/song1.wav");
		wav_track_one.load("./Sounds/song2.wav");
		wav_track_one.load("./Sounds/song3.wav");
		wav_track_one.load("./Sounds/song4.wav");
		wab_birds.load("./Sounds/song4.wav");
	}
	void handleAudio() {
		if (!audio_init) {
			initAudio();
