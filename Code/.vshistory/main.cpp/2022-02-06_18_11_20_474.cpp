...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override {
		...
		if (!drawMap) {
			...
			DrawPartialDecal(olc::vf2d(dX - 80, dY + 32), buildings, olc::vf2d(32, 32 * ((timer / 5) % 6)), olc::vf2d(16, 32), olc::vf2d(z, z));
			DrawPartialDecal(olc::vf2d(dX - 16, dY + 32), buildings, olc::vf2d(32, 32 * ((timer / 5) % 6)), olc::vf2d(16, 32), olc::vf2d(z, z));
			DrawPartialDecal(olc::vf2d(dX + 64, dY + 32), buildings, olc::vf2d(32, 32 * ((timer / 5) % 6)), olc::vf2d(16, 32), olc::vf2d(z, z));
		}
