...
private:
	std::vector<olc::Pixel> colors = { WHITE, olc::Pixel(16, 138, 231), olc::Pixel(166, 43, 58)m olc::Pixel(39, 213, 216), olc::Pixel(76, 182, 92), olc::Pixel(231, 228, 0),  olc::Pixel(255, 140, 0) , olc::Pixel(114, 71, 255) , olc::Pixel(220, 0, 213) };
